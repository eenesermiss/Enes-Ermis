...
import static satproje.listener.alert.notTeacher.teacherAlert;
import static satproje.controller.program.branch2Availables.getTeacherAvailables2;
import static satproje.controller.program.data.dataGet.*;
import static satproje.controller.program.data.dataSave.sendAcademicProgram;
import static satproje.controller.program.data.dataSet.*;
import static satproje.controller.program.node.nodeLesson.FinishLessonNode;
import static satproje.controller.program.branch1Availables.*;
