...
import satproje.listener.ComboBoxEntry;
import satproje.listener.TextFieldEntry;
import satproje.listener.tabloModel;
...
import static satproje.controller.frame.button.backButton.backButton;
import static satproje.controller.frame.button.loginButton.loginButton;
import static satproje.controller.frame.button.nextButton.nextButton;
import static satproje.controller.frame.button.removeButton.removeButton;
import static satproje.controller.frame.button.saveButton.saveButton;
import static satproje.controller.frame.button.updateButton.updateButton;
import static satproje.controller.frame.config.comboBox.genereted;
import static satproje.controller.frame.mouseListener.addMouseListenerToTable;
    ...
    public static void main(String frameName, int frameSizeX, int frameSizeY, ArrayList fieldNames, int rows, String frameType, String tabloSql) {
        ...
        for (Object field : fieldNames) {
            ...
            if ((frameType.equals("episodeCourses") || frameType.equals("teacherCourses")) && fieldName.equals("Code")
                ...
                TextFieldEntry entry = new TextFieldEntry(fieldName, (JTextField) inputField);
